...
import com.qa.rediff.utilities.Rediff_ExtentReporter;
...
public class My_Listeners implements ITestListener {
	...
	public void onStart(ITestContext context) {
		try {
			extentReport = Rediff_ExtentReporter.generateExtentReport();
		} catch (Exception e) {
			
			e.printStackTrace();
		}
		System.out.println("Initialization and Execution of Rediff Project Commenced");
